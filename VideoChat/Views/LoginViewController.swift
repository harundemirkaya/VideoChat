...
class LoginViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        txtFieldEmail.txtFieldEmailConstraints(stackView, lblTitle: lblTitle, view: view)
...
private extension UIView{
    ...
    func txtFieldEmailConstraints(_ stackView: UIStackView, lblTitle: UILabel, view: UIView){
        stackView.addSubview(self)
    ...
    func btnLoginConstraints(_ stackView: UIStackView, txtFieldPassword: UITextField, view: UIView){
        stackView.addSubview(self)
